...
class IpylabLogHandler(logging.Handler):
    ...
    def register_callback(self, callback: Callable[[logging.LogRecord], Any], *, remove=False) -> None:
        """
...
class IpylabLogFormatter(logging.Formatter):
    ...
    def get_ref(self, record: logging.LogRecord, key: Literal["owner", "obj"]) -> object | None:
        "Get the 'owner' object from the record if it exists."
