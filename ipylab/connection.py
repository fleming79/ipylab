...
class Connection(Singular, Ipylab):
    ...
    def close(self, *, dispose=True) -> None:
        ...
        Args:
            dispose: Whether to dispose of the object at the frontend."""
    ...
    def get_connection(cls, connection_id: str) -> Self:
        """
        Get the instance of a connection correspond to `connection_id`.

        Args:
            param connection_id: The connection id created by the method `to_id`.
        """
