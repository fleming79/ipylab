...
class Ipylab(HasApp, WidgetBase):
    ...
    def get_kernel_client_id(cls) -> str:
        "The kernel client_id can be used to determine the page from which a message originated."
    ...
    def is_ready(self) -> bool:
        "Will return True when it is ready for the current page context and not closed."
        return bool(
            (page_id := self.get_page_id())
