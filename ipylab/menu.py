...
class RankedMenu(Ipylab):
    ...
    async def add_item(
        ...
        *,
        ...
        """
        Add a command, subitem or separator to the menu [ref](https://jupyterlab.readthedocs.io/en/4.0.x/api/classes/ui_components.RankedMenu.html#addItem.addItem-1).

        Args:
            command: A connection to a command or the string of the command.
            submenu: A connection to the submenu to add.
            rank: The rank to apply to the item
            type: The type of item that is being added.
            args: The default argument to use with the command.
        """
...
class MainMenu(Menu):
    """Direct access to the Jupyterlab main menu [ref](https://jupyterlab.readthedocs.io/en/4.0.x/api/classes/mainmenu.MainMenu.html)."""
    ...
    async def add_menu(self, menu: MenuConnection, *, update=True, rank: int = 500) -> None:
        """Add a top level menu to the shell [ref](https://jupyterlab.readthedocs.io/en/4.0.x/api/classes/mainmenu.MainMenu.html#addMenu)."""
        options = {"rank": rank}
...
class ContextMenu(Menu):
    ...
    async def add_item(
        ...
        *,
        ...
        Args:
            command: The command to add to the menu.
            selector: The *class selector* to use for the context.
            submenu: A connection to the submenu to add.
            rank: The rank to apply to the item
            type: The type of item that is being added.
            args: The default argument to use with the command.
